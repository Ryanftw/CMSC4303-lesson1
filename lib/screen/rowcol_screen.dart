    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            crossAxisAlignment:
                CrossAxisAlignment.center, //How we want to align the elements
            /*mainAxisAlignment:
                MainAxisAlignment.center, // in the list according to the axis*/
            children: [
              Stack(
                children: [
                  Container(
              ...
              Row(
                children: [
                  ...
                  Expanded(child: Image.asset('images/airplane.jfif')),
                ],
              ),
              Container(
                color: Colors.teal[900],
